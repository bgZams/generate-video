...
narration = narration.replace(/const DEFAULT_MODEL = 'gpt-4o-mini'/g, "const DEFAULT_MODEL = 'gemini-flash-latest'");
...
server = server.replace(/process\.env\.OPENAI_API_KEY/g, 'process.env.GEMINI_API_KEY || process.env.OPENAI_API_KEY');
fs.writeFileSync(serverFile, server);
console.log('   ✓ Updated server.js to use GEMINI_API_KEY\n');

console.log('✅ All changes applied successfully!\n');
console.log('📝 Next steps:');
console.log('   1. Ensure you have .env file with: GEMINI_API_KEY=your_key_here');
